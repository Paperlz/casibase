...
func initAPI() {
	...
	beego.Router("/api/start-wechat-ilink-test", &controllers.ApiController{}, "POST:StartWeChatIlinkTest")
	beego.Router("/api/wait-wechat-ilink-test", &controllers.ApiController{}, "POST:WaitWeChatIlinkTest")
	beego.Router("/api/reply-wechat-ilink-test", &controllers.ApiController{}, "POST:ReplyWeChatIlinkTest")
	beego.Router("/api/stop-wechat-ilink-test", &controllers.ApiController{}, "POST:StopWeChatIlinkTest")
