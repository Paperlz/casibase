...
func initBuiltInTools() {
	builtInTools := []*Tool{
		...
		},
		{
			...
			PromptExamples: []string{
				"Get metadata and available formats for this public YouTube video: https://www.youtube.com/watch?v=dQw4w9WgXcQ",
				"Download the best MP4 version of https://www.youtube.com/watch?v=dQw4w9WgXcQ to /tmp/videos.",
				"Download https://www.youtube.com/watch?v=dQw4w9WgXcQ with the filename template %(title)s-%(id)s.%(ext)s.",
				"Extract high-quality MP3 audio from https://www.youtube.com/watch?v=dQw4w9WgXcQ to /tmp/audio.",
			},
			State: "Active",
		},
		{
