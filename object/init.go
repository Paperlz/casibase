...
func initBuiltInTools() {
	builtInTools := []*Tool{
		...
		},
		{
			...
			PromptExamples: []string{
				"Search the web for a public nonprofit awareness video, then get its metadata and available formats.",
				"Search the web for a public nonprofit awareness video, then download the best MP4 version to /tmp/videos.",
				"Search the web for a public nonprofit awareness video, then download it with the filename template %(title)s-%(id)s.%(ext)s.",
				"Search the web for a public nonprofit awareness video, then extract high-quality MP3 audio to /tmp/audio.",
			},
			State: "Active",
		},
		{
